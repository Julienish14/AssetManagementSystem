			...
			<div class="col-lg-9 col-md-9 col-sm-9 main_asset">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 head">
						<a href="trashed.php"><h3>trashed<span>Items</span></h3></a>
						  <ul>
							    <li>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 mid">
						<nav>
						  <ul>
						    <li class="active"><a href="#"><i class="far fa-address-book"></i><span> Trashed list</span></a></li>
				 		<!--	<li class="addn"><a href="#">(+)Update</a></li> --> 
					...
					<div class="col-lg-12 col-md-12 col-sm-12 content">
						<table>
							<tr>
								...
								<?php require_once "inc/disp_tras.php" ?>	
						</table>
					</div>
				</div>	
			</div>
